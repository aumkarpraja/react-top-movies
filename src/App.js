...
class App extends Component{
	...
	search = async e => {
		...
		const response = await fetch(`https://api.themoviedb.org/3/search/movie?api_key=${apiKey}&language=en-US&query=${searchText}&page=1&include_adult=false`);
				...
				<AppBar position="fixed">
        			<Toolbar>
						...
						<form onSubmit={ this.search }>
							<Input type="search" value={ searchText } onChange={ this.searchTextChanged }></Input>
						</form>
       				</Toolbar>
      			</AppBar>
